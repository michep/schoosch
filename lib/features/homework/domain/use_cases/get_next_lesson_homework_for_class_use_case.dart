...
final class GetNextLessonHomeworkForClassUseCase extends BaseUseCase<List<HomeworkModel>, GetHomeworkParams> {
  ...
  Future<List<HomeworkModel>> invoke(params) async {
    return await _homeworkRepository.getHomeworkNextLessonForClass(
      params.classId,
      params.curriculumId,
      params.date,
    );

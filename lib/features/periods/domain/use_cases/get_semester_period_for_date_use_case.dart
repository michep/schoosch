...
final class GetSemesterPeriodForDateUseCase extends BaseUseCase<StudyPeriodModel?, DateTime> {
  ...
  Future<StudyPeriodModel?> invoke(params) async {
    return await _periodsRepository.getSemesterPeriodForDate(params);
  }
}
  ...
  DayScheduleModel.fromMap(this._id, Map<String, dynamic> map) {
    ...
    if (map.containsKey('lesson') && map['lesson'] is List) {
      for (var l in map['lesson'] as List) {
        ...
        _lessons.add(LessonModel.fromMap(aclass.id!, _id!, l['_id'], l));
      }
      _lessonsLoaded = true;
    }
  }
...
class ClassScheduleModel extends DayScheduleModel {
  ...
  //     _lessons.addAll(await Get.find<ProxyStore>().getScheduleLessons(_classId, this, date: date, needsEmpty: needsEmpty));
  //     _lessonsLoaded = true;
  //   }
  //   return _lessons;
  // }

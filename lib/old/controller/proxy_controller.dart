...
import 'package:schoosch/old/model/attachments_model.dart';
...
class ProxyStore extends getx.GetxController {
  ...
  Future<List<PersonModel>> getAllPeople() async {
    var js = await BaseDioFunctions.getList(path: '/person');
  ...
  Future<PersonModel> getPerson(String id) async {
    var js = await BaseDioFunctions.getMapData(path: '/person/$id');

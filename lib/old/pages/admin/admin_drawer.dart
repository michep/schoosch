...
import 'package:schoosch/old/pages/admin/class_list.dart';
import 'package:schoosch/old/pages/admin/curriculum_list.dart';
import 'package:schoosch/old/pages/admin/daylessontime_list.dart';
import 'package:schoosch/old/pages/admin/institution.dart';
import 'package:schoosch/old/pages/admin/marktype_list.dart';
import 'package:schoosch/old/pages/admin/people_list.dart';
import 'package:schoosch/old/pages/admin/class_choice_page.dart';
import 'package:schoosch/old/pages/admin/studyperiod_list.dart';
import 'package:schoosch/old/pages/admin/venue_list.dart';
import 'package:schoosch/old/widgets/drawerheader.dart';
import 'package:schoosch/old/pages/about_page.dart';

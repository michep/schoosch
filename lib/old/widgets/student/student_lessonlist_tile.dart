...
import 'package:schoosch/old/pages/student/student_lesson_page.dart';
    ...
    return FutureBuilder(
      ...
      builder: (context, snap) {
        ...
        return ListTile(
          ...
          tileColor: widget._lesson.type == LessonType.replacment ? Colors.grey.withValues(alpha: 0.1) : null,

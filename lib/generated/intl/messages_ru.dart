...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "appTiile": MessageLookupByLibrary.simpleMessage("Скуш - школьный дневник"),
    "chooseClassTitle": MessageLookupByLibrary.simpleMessage("Выбор класса"),
    "classGrade": MessageLookupByLibrary.simpleMessage("Год обучения"),
    "classHomeworkCompletionsTitle": MessageLookupByLibrary.simpleMessage(
      "Выполнение",
    ),
    "classHomeworkTitle": MessageLookupByLibrary.simpleMessage(
      "Задание всему классу",
    ),
    "classList": MessageLookupByLibrary.simpleMessage("Учебные классы"),
    "classMaster": MessageLookupByLibrary.simpleMessage(
      "Классный руководитель",
    ),
    "className": MessageLookupByLibrary.simpleMessage(
      "Название учебного класса",
    ),
    "classSchedule": MessageLookupByLibrary.simpleMessage(
      "Расписание времени уроков",
    ),
    "classScheduleName": m0,
    "classStudents": MessageLookupByLibrary.simpleMessage("Учащиеяся класса"),
    "classStudentsTitle": MessageLookupByLibrary.simpleMessage(
      "Ученики класса",
    ),
    "commentTitle": MessageLookupByLibrary.simpleMessage("Комментарий"),
    "currentLessonAbsences": MessageLookupByLibrary.simpleMessage(
      "Отсутствующие",
    ),
    "currentLessonClassHomework": MessageLookupByLibrary.simpleMessage(
      "Задание классу на этот урок",
    ),
    "currentLessonHomeworks": MessageLookupByLibrary.simpleMessage(
      "ДЗ на сегодня",
    ),
    ...
    "curriculumAlternateName": MessageLookupByLibrary.simpleMessage(
      "Альтернативное название",
    ),
    "curriculumList": MessageLookupByLibrary.simpleMessage("Учебные предметы"),
    "curriculumName": MessageLookupByLibrary.simpleMessage("Учебный предмет"),
    "curriculumStudents": MessageLookupByLibrary.simpleMessage(
      "Группа учащихся",
    ),
    "curriculumTeacher": MessageLookupByLibrary.simpleMessage("Преподаватель"),
    "dayLessonTimeName": MessageLookupByLibrary.simpleMessage(
      "Раписание времени уроков",
    ),
    "dayLessontimeList": MessageLookupByLibrary.simpleMessage(
      "Расписания времени уроков",
    ),
    "dayScheduleList": MessageLookupByLibrary.simpleMessage(
      "Раписание занятий",
    ),
    ...
    "errorClassStudentsEmpty": MessageLookupByLibrary.simpleMessage(
    ...
    "errorMarkError": MessageLookupByLibrary.simpleMessage(
    ...
    "errorPersonBirthdayEmpty": MessageLookupByLibrary.simpleMessage(
    ...
    "errorPersonParentClassesEmpty": MessageLookupByLibrary.simpleMessage(
      "Нужно выбрать классы",
    ),
    "errorPersonParentStudentsEmpty": MessageLookupByLibrary.simpleMessage(
      "Нужно выбрать учащихся",
    ),
    ...
    "errorStudentEmpty": MessageLookupByLibrary.simpleMessage(
      "Учченик должен быть выбран",
    ),
    ...
    "errorUnknownMarkType": MessageLookupByLibrary.simpleMessage(
      "Нужно выбрать Тип оценки",
    ),
    "errorUnknownPersonType": MessageLookupByLibrary.simpleMessage(
      "unknown person type",
    ),
    "errorVenueEmpty": MessageLookupByLibrary.simpleMessage(
      "Кабинет должен быть выбран",
    ),
    "freeLessonsTitle": MessageLookupByLibrary.simpleMessage(
      "Поиск свободных уроков",
    ),
    "freeTeachersTitle": MessageLookupByLibrary.simpleMessage(
    ...
    "homeworkTextTitle": MessageLookupByLibrary.simpleMessage("Текст задания"),
    "homeworkTitle": MessageLookupByLibrary.simpleMessage("Домашнее задание"),
    ...
    "loginPageTitle": MessageLookupByLibrary.simpleMessage("Вход в приложение"),
    "markTitle": MessageLookupByLibrary.simpleMessage("Оценка"),
    "markTypeLabel": MessageLookupByLibrary.simpleMessage("Короткое название"),
    ...
    "newCurriculum": MessageLookupByLibrary.simpleMessage(
    ...
    "nextLessonHomeworks": MessageLookupByLibrary.simpleMessage("Задать ДЗ"),
    ...
    "periodSemester": MessageLookupByLibrary.simpleMessage("учебный период"),
    ...
    "personRelatedClasses": MessageLookupByLibrary.simpleMessage(
      "Связанные классы",
    ),
    "personRelatedStudents": MessageLookupByLibrary.simpleMessage(
      "Связанные учащиеся",
    ),
    "personType": MessageLookupByLibrary.simpleMessage("Тип"),
    "personTypeAdmin": MessageLookupByLibrary.simpleMessage("Администратор"),
    "personTypeAll": MessageLookupByLibrary.simpleMessage("Все типы"),
    "personTypeObserver": MessageLookupByLibrary.simpleMessage("Наблюдатель"),
    ...
    "personTypeTeacher": MessageLookupByLibrary.simpleMessage("Преподаватель"),
    "personalHomeworkTitle": MessageLookupByLibrary.simpleMessage("Д/З личное"),
    "replacementsTitle": MessageLookupByLibrary.simpleMessage(
      "Подмены в расписании",
    ),
    ...
    "scheduleFromDate": MessageLookupByLibrary.simpleMessage(
      "Начало действия расписания",
    ),
    "scheduleLessonOrder": m3,
    "scheduleNoLesson": MessageLookupByLibrary.simpleMessage("нет этого урока"),
    "scheduleTillDate": MessageLookupByLibrary.simpleMessage(
      "Окончание действия",
    ),
    "search": MessageLookupByLibrary.simpleMessage("Поиск"),
    "setCompleted": MessageLookupByLibrary.simpleMessage(
      "сообщить о выполнении",
    ),
    "setMarkTitle": MessageLookupByLibrary.simpleMessage("Поставить оценку"),
    "setUncompleted": MessageLookupByLibrary.simpleMessage(
    ...
    "studyPeriodList": MessageLookupByLibrary.simpleMessage("Учебные периоды"),
    "studyPeriodTitle": MessageLookupByLibrary.simpleMessage("Учебный период"),
    "studyPeriodTypeTitle": MessageLookupByLibrary.simpleMessage(
      "Тип учебного периода",
    ),
    "tabScheduleHomeworksTitle": MessageLookupByLibrary.simpleMessage(
      "Расписание/ДЗ",
    ),
    "tabStudentsPerformance": MessageLookupByLibrary.simpleMessage(
      "Успеваемость",
    ),
    "tillTimeTitle": MessageLookupByLibrary.simpleMessage("Время окончания"),
    ...
    "updateMarkTitle": MessageLookupByLibrary.simpleMessage("Изменить оценку"),
    "userProfileTitle": MessageLookupByLibrary.simpleMessage(
      "Профиль пользователя",
    ),
    "venueList": MessageLookupByLibrary.simpleMessage("Кабинеты и помещения"),

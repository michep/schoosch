...
class _HomeworkPageState extends State<HomeworkPage> {
  ...
  void initState() {
    ...
    attachments = widget.homework.getAttachments();
  ...
  void save() async {
    if (_formKey.currentState!.validate()) {
      ...
      addedAttachments.addAll(attachments.where((e) => e.filebytes == null).toList());

      var attachmentsMap = addedAttachments
          .map(
  ...
  Future<List<AttachmentModel>> saveAttachments() async {
    ...
    List<AttachmentModel> newAttachments = attachments.where((e) => e.filebytes != null).toList();

    List<AttachmentModel> addedAttachments = [];

    await Future.forEach(newAttachments, (a) async {
